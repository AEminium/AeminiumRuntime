...
class Fibonacci_f_2_ret_1_infix implements aeminium.runtime.Body {
  Fibonacci_f_2_ret_1_infix(  Fibonacci_f_2_ret ae_parent){
    ...
    AeminiumHelper.schedule(this.ae_task,ae_parent == null ? AeminiumHelper.NO_PARENT : ae_parent.ae_task,java.util.Arrays.asList(this.ae_Fibonacci_f_2_ret_1_infix_1_invoke.ae_task,this.ae_Fibonacci_f_2_ret_1_infix_2_invoke.ae_task));
  }
