...
class Integrate_computeRec_8_if_2_ret implements aeminium.runtime.Body {
  Integrate_computeRec_8_if_2_ret(  Integrate_computeRec_8_if ae_parent){
  ...
  public void execute(  aeminium.runtime.Runtime rt,  aeminium.runtime.Task task) throws Exception {
    this.ae_parent.ae_parent.ae_ret=this.ae_parent.ae_parent.ae_Integrate_computeRec_7_varstmt.alr;
