...
class Complex_reciprocal_2_ret implements aeminium.runtime.Body {
  Complex_reciprocal_2_ret(  Complex_reciprocal ae_parent){
    this.ae_parent=ae_parent;
    this.ae_task=AeminiumHelper.createNonBlockingTask(this,AeminiumHelper.NO_HINTS);
    this.ae_Complex_reciprocal_2_ret_1_new=new Complex_reciprocal_2_ret_1_new(this);
  ...
  public Complex_reciprocal_2_ret_1_new ae_Complex_reciprocal_2_ret_1_new;
}
