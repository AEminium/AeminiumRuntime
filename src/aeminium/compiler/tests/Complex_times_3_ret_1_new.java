...
class Complex_times_3_ret_1_new extends aeminium.runtime.CallerBodyWithReturn<aeminium.compiler.tests.Complex> implements aeminium.runtime.Body {
  Complex_times_3_ret_1_new(  Complex_times_3_ret ae_parent){
    ...
    AeminiumHelper.schedule(this.ae_task,ae_parent == null ? AeminiumHelper.NO_PARENT : ae_parent.ae_task,java.util.Arrays.asList(this.ae_parent.ae_parent.ae_Complex_times_1_varstmt.ae_task,this.ae_parent.ae_parent.ae_Complex_times_2_varstmt.ae_task));
  }
