...
class Fibonacci_f_2_ret implements aeminium.runtime.Body {
  Fibonacci_f_2_ret(  Fibonacci_f ae_parent){
    ...
    AeminiumHelper.schedule(this.ae_task,ae_parent == null ? AeminiumHelper.NO_PARENT : ae_parent.ae_task,java.util.Arrays.asList(this.ae_Fibonacci_f_2_ret_1_infix.ae_task,this.ae_Fibonacci_f_2_ret_1_infix.ae_Fibonacci_f_2_ret_1_infix_1_invoke.ae_task,this.ae_parent.ae_Fibonacci_f_1_if.ae_task,this.ae_Fibonacci_f_2_ret_1_infix.ae_Fibonacci_f_2_ret_1_infix_2_invoke.ae_task));
  }
