...
class Integrate_computeRec_7_varstmt implements aeminium.runtime.Body {
  Integrate_computeRec_7_varstmt(  Integrate_computeRec ae_parent){
    ...
    AeminiumHelper.schedule(this.ae_task,ae_parent == null ? AeminiumHelper.NO_PARENT : ae_parent.ae_task,java.util.Arrays.asList(this.ae_parent.ae_Integrate_computeRec_5_varstmt.ae_task,this.ae_parent.ae_Integrate_computeRec_6_varstmt.ae_task));
  }
