...
class FFT_main_2_varstmt_1_invoke extends aeminium.runtime.CallerBodyWithReturn<aeminium.compiler.tests.Complex[]> implements aeminium.runtime.Body {
  FFT_main_2_varstmt_1_invoke(  FFT_main_2_varstmt ae_parent){
    ...
    AeminiumHelper.schedule(this.ae_task,ae_parent == null ? AeminiumHelper.NO_PARENT : ae_parent.ae_task,java.util.Arrays.asList(this.ae_parent.ae_parent.ae_FFT_main_1_varstmt.ae_FFT_main_1_varstmt_1_invoke.ae_task,this.ae_parent.ae_parent.ae_FFT_main_1_varstmt.ae_task));
  }
