...
class Fibonacci_f_1_if_2_ret_2_invoke implements aeminium.runtime.Body {
  Fibonacci_f_1_if_2_ret_2_invoke(  Fibonacci_f_1_if_2_ret ae_parent){
  ...
  public void execute(  aeminium.runtime.Runtime rt,  aeminium.runtime.Task task) throws Exception {
    this.ae_deferred.schedule(java.util.Arrays.asList(this.ae_task),this.ae_parent.ae_parent.ae_parent.n - 2);
  }
